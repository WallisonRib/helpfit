...
export default function SocialLogin() {
    ...
    return (
        <div className="flex flex-col items-center gap-4 mt-6">
            <p className="text-primary text-sm font-medium">Entrar com</p>
